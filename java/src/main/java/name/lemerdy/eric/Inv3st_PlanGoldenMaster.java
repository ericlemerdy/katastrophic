...
public class Inv3st_PlanGoldenMaster {
    public static final int MAX_HOURS = 12;
    private static Object currency = new String();
    private String _out;
    private static List<String> allowingPrfts1;

    private Inv3st_PlanGoldenMaster(String output) {
        this._out = output;
    }

    public static Inv3st_PlanGoldenMaster input(String input) {
        ...
        synchronized (allowingPrfts1) {
            ...
            return new Inv3st_PlanGoldenMaster(output1.toString());
        }
    }
